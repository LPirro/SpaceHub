...
data class LaunchRemote(
    ...
    @SerializedName("vid_urls") val videoUrls: List<UrlRemote>,
    @SerializedName("info_urls") val infoURLs: List<UrlRemote>,
    ...
    @SerializedName("weather_concerns") val weatherConcerns: String?,
    @SerializedName("failreason") val failReason: String?,
    @SerializedName("hashtag") val hashtag: String?,
    @SerializedName("net_precision") val netPrecision: NetPrecisionRemote?,
)
