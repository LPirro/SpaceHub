...
import com.lpirro.spacehub.launches.data.network.model.MissionPatchesRemote
...
class MissionPatchesMapperImpl : MissionPatchMapper {
    override fun mapToDomain(missionPatchesRemote: MissionPatchesRemote) = MissionPatches(
